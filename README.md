...
npm install -g release/orchescope-0.7.0.tgz
```
...
```json
{ "ok": true, "command": "audit", "version": "0.7.0", "data": { "…": "…" } }
{ "ok": false, "command": "audit", "version": "0.7.0", "data": null, "error": { "code": "…", "category": "…", "message": "…" } }
```
