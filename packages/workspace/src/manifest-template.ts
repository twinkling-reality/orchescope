...
export const manifestTemplate = (): string =>
  [
    ...
    '# A source citation supplies definedIn, definedAtLine and definedFileHash together. The hash is the',
    '# lowercase SHA-256 of the file bytes inspected when the citation is written.',
    '#',
